...
class Minesweeper:
    def __init__(self, width=10, height=10, mines=10):
        ...
        self.safe_cells = self.total_cells - mines  # total de casillas sin minas
        self.revealed_count = 0  # contador de casillas reveladas
    ...
    def reveal(self, x, y):
        if self.revealed[y][x]:
            return True  # ya revelada, no pasa nada
        if (y * self.width + x) in self.mines:
            return False
